...
func RegisterRoutes(r *gin.Engine, h *Handler, validateToken gin.HandlerFunc, rateLimiter gin.HandlerFunc) {
	r.POST("/api/v1/auth/signup", rateLimiter, h.SignUp)
	r.POST("/api/v1/auth/signin", rateLimiter, h.SignIn)
